...
/************************************************
part 10 自动补充文件类型 | 默认搜索*.txt | 默认指定目录 | 打开文件风格(文件存在/文件多选)
...
{
	LPCTSTR szFilter = _T("文本文件(*.txt)|*.txt|代码文件 (*.h; *.c; *.cpp)|*.h; *.c; *.cpp|Worksheet Files (*.xls)|*.xls|Data Files (*.xlc;*.xls)|*.xlc; *.xls|所有文件 (*.*)|*.*||");
